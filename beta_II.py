    ...
    st.markdown(f"""
        <div style="background: #111; padding: 25px; border: 1px solid #E63946; text-align: center;">
            <div style="display: flex; justify-content: space-around; align-items: center;">
                <div style="color: #FFCC00; font-weight: bold; font-family: 'Arial Black'; font-size: 1.1rem;">🏠 {moradia}</div>
                <div style="color: #E63946; font-size: 1.5rem; margin: 0 15px;">⚡――――▶</div>
                <div style="color: #FFCC00; font-weight: bold; font-family: 'Arial Black'; font-size: 1.1rem;">💼 {trabalho}</div>
            </div>
