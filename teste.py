...
g_on = g1.number_input("🚍 ÔNIBUS", min_value=0.0, key="f_on")
g_me = g2.number_input("🚇 METRÔ",  min_value=0.0, key="c_me")
g_tr = g3.number_input("🚆 TREM",   min_value=0.0, key="c_tr")
g_ap = g4.number_input("🚗 APP",    min_value=0.0, key="c_ap")
g_ca = g5.number_input("⛽ CARRO/COMBUSTÍVEL",min_value=0.0, key="c_ca")
